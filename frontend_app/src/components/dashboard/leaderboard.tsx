export default function Leaderboard() {
  ...
  return (
    <div className="w-[35%] p-5 bg-slate-950 rounded-2xl outline outline-2 outline-offset-[-2px] outline-slate-900 inline-flex flex-col justify-start items-start gap-3.5 overflow-hidden">
