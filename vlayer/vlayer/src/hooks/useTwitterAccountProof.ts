...
const webProofConfig: WebProofConfig<Abi, string> = {
  ...
  steps: [
    startPage("https://github.com/", "Go to github.com login page"),
    expectUrl("https://github.com/djeck1432/spotnet/pull/150", "Get to your PR"),
    notarize(
      "https://github.com/djeck1432/spotnet/pull/150/page_data/status_checks",
      "GET",
